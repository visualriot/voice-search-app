...
export default function VoiceButton() {
  ...
  return (
    <Button
      ...
      className="bg-gradient-to-b from-[#FF0040] to-[#FF6B35] text-white font-semibold shadow-lg px-[20vw] py-[20vh] text-4xl hover:scale-103 transition-transform flex flex-col items-center justify-center"
    >
